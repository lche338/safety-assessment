...
class safety_questionnaire_database(db.Model):
    ...
    difficulties_walking = db.Column(db.Text)
    ...
    clear_path,floors_condition,difficulties_walking,non_slip,grab_bars,telephone_reach,difficulties_chairs,items_reached,
    handrails_needed,smoke_detectors,fire_extinguisher,contact_information,key_entry,exit_plan):
        ...
        self.difficulties_walking = difficulties_walking
